...
class Ring_NAND3(pya.PCellDeclarationHelper):
  ...
  def __init__(self):
    ...
    super(Ring_NAND3, self).__init__()
  ...
  def display_text_impl(self):
    ...
    return "STD Cell Ring_Osc_NAND3:(ratio=" + str((self.r)) + ",Width="+ "90*"+str((self.n_d)) + ")"
  ...
  def impl(self):
    ...
    x2 = x1 + 5*d_x_0
    self.transistor(1, x2, y, w_d, self.n_d, self.l_d, True, False, 100, d_x_1, right_ov_load, 0)
    #gates name
    iTregion = pya.TextGenerator.default_generator().text\
    ...
    x5 = x4 + 5*d_x_0
    self.transistor(1, x5, y, w_d, self.n_d, self.l_d, True, False, 100, d_x_0, right_ov_load, 1)
    #gates name
    iTregion = pya.TextGenerator.default_generator().text\
    ...
    x6 = x5 + 5*d_x_0
    self.transistor(1, x6, y, w_d, self.n_d, self.l_d, True, False, 100, d_x_1, right_ov_load, 1)
    #gates name
    iTregion = pya.TextGenerator.default_generator().text\
    ...
    x9 = x8 + 5*d_x_0
    self.transistor(1, x9, y, w_d, self.n_d, self.l_d, True, False, 100, d_x_0, right_ov_load, 0)
    #gates name
    iTregion = pya.TextGenerator.default_generator().text\
    ...
    x10 = x9 + 5*d_x_0
    self.transistor(1, x10, y, w_d, self.n_d, self.l_d, True, False, 100, d_x_1, right_ov_load, 0)
    #gates name
    iTregion = pya.TextGenerator.default_generator().text\
    ...
    x13 = x12 + 5*d_x_0
    self.transistor(1, x13, y, w_d, self.n_d, self.l_d, True, False, 100, d_x_0, right_ov_load, 1)
    #gates name
    iTregion = pya.TextGenerator.default_generator().text\
    ...
    x14 = x13 + 5*d_x_0
    self.transistor(1, x14, y, w_d, self.n_d, self.l_d, True, False, 100, d_x_1, right_ov_load, 1)
    #gates name
    iTregion = pya.TextGenerator.default_generator().text\
    ...
    x17 = x16 + 5*d_x_0
    self.transistor(1, x17, y, w_d, self.n_d, self.l_d, True, False, 100, d_x_0, right_ov_load, 0)
    #gates name
    iTregion = pya.TextGenerator.default_generator().text\
    ...
    x18 = x17 + 5*d_x_0
    self.transistor(1, x18, y, w_d, self.n_d, self.l_d, True, False, 100, d_x_1, right_ov_load, 0)
    #gates name
    iTregion = pya.TextGenerator.default_generator().text\
    ...
    if(self.pad):
        ...
        name = pya.TextGenerator.default_generator().text\
            ("Ring_NAND3", 0.001, 35).move(-450/dbu, -150 / dbu)
...
class MyLib(pya.Library):
  ...
  def __init__(self):
    ...
    # Set the description
    self.description = "Ring_NAND3"
    
    # Create the PCell declarations
    self.layout().register_pcell("Ring_NAND3", Ring_NAND3())
    # That would be the place to put in more PCells ...
    
    # Register us with the name "MyLib".
    # If a library with that name already existed, it will be replaced then.
    self.register("Ring_NAND3")
