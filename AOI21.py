...
class AOI21_v2(pya.PCellDeclarationHelper):
  """
  ...
  def display_text_impl(self):
    ...
    return "STD Cell AOI21:(ratio=" + str((self.r)) + ",Width="+ "90*"+str((self.n_d)) + ")"
