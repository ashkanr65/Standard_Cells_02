                ...
                for n_f in inverter_id_params["n_f"]:
                    if (i>=x and j>y):
                        ...
                        if(i>=x and j>y):
                            ...
                            i +=1
<<<<<<< HEAD
                        sub_pcell = ly.create_cell(ones, "STD_Cell_V2", { "pad": 1,"n_d": n_f, "name": "1_"+"%03d"%device_id, "s": 2.5, "via": 2.5, "o": 2.5 })
=======
                        sub_pcell = ly.create_cell(ones, "STD_Cell_V2", { "pad": 1,"n_d": n_f, "name": "1_"+"%03d"%device_id, "s": 2 })
>>>>>>> 82b6ce883cb0198cc1d451e847f39b84e768ec34
                            ...
                            if (i>=x and j>y):
                                ...
                                if twos == 'MUX_2_V2':
                                    if(i>=x and j>y):
                                        ...
                                        i +=1
<<<<<<< HEAD
                                    sub_pcell = ly.create_cell(twos, "STD_Cell_V2", { "pad": 1,"n_d": n_f, "sel": TF, "name": "1_"+"%03d"%device_id, "s": 2.5, "via": 2.5, "o": 2.5})
=======
...
>>>>>>> 82b6ce883cb0198cc1d451e847f39b84e768ec34
                                    ...
                                    if(i>=x and j>y):
                                        ...
                                        i +=1
<<<<<<< HEAD
                                    sub_pcell = ly.create_cell(twos, "STD_Cell_V2", { "pad": 1,"n_d": n_f, "q": TF, "name": "1_"+"%03d"%device_id, "s": 2.5, "via": 2.5, "o": 2.5})
=======
                        ...
                        for M4 in inverter_id_params["Mod_4"]:
                            if (i>=x and j>y):
                                ...
                                if(i>=x and j>y):
                                    ...
                                    i +=1
<<<<<<< HEAD
                                sub_pcell = ly.create_cell(fours, "STD_Cell_V2", { "pad": 1,"n_d": n_f, "AO": M4, "name": "1_"+"%03d"%device_id, "s": 2.5, "via": 2.5, "o": 2.5})
=======
                        ...
                        for s0 in inverter_id_params["Mod_2"]:
                            if (i>=x and j>y):
                                ...
                                if(i>=x and j>y):
                                    ...
                                    i +=1
<<<<<<< HEAD
                                sub_pcell = ly.create_cell("MUX_4_V2", "STD_Cell_V2", { "pad": 1,"n_d": n_f, "sel0": s0, "sel1": s1, "name": "1_"+"%03d"%device_id, "s": 2.5, "via": 2.5, "o": 2.5})
=======
                        ...
                        for AO in inverter_id_params["Mod_7"]:
                            if (i>=x and j>y):
                                ...
                                if(i>=x and j>y):
                                    ...
                                    i +=1
<<<<<<< HEAD
                                sub_pcell = ly.create_cell(seven, "STD_Cell_V2", { "pad": 1,"n_d": n_f, "AO": AO, "name": "1_"+"%03d"%device_id, "s": 2.5, "via": 2.5, "o": 2.5})
=======
