...
class NAND3_v2(pya.PCellDeclarationHelper):
  """
  ...
  def display_text_impl(self):
    ...
    return "STD Cell NAND3:(ratio=" + str((self.r)) + ",Width="+ "90*"+str((self.n_d)) + ")"
