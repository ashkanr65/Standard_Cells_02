...
class Ring_NOR3(pya.PCellDeclarationHelper):
  ...
  def impl(self):
    ...
    if (self.buffer == True):
        ...
        self.transistor(1, x20, y, w_d, 3*self.n_d, self.l_d, True, False, 0, l_x, 0, 1)
        #gates name
        # iTregion = pya.TextGenerator.default_generator().text\
        ...
        self.transistor(2, x21, y, w_d, 3*self.n_d, self.l_d, True, False, 101, d_x_101, d_x_101, 1)
        #gates name
        # iTregion = pya.TextGenerator.default_generator().text\
        ...
        self.transistor(2, x22, y, w_d, 3*self.n_d, self.l_d, True, False, 101, d_x_101, right_ov_load, 1)
        #gates name
        # iTregion = pya.TextGenerator.default_generator().text\
