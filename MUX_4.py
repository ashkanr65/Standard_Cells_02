...
class MUX_4(pya.PCellDeclarationHelper):
  ...
  def impl(self):
    ...
    #Input I0 and S0 and S1
    # (level, x, y, w_i, n_i, l_i, bg, Load, In_Con, overlap_left, overlap_rigth, out)0
    self.transistor(1, x0, y, w_d, self.n_d, self.l_d, True, False, 0, 0, 0, 0)
    #gates name
    ...
    x1 = x0 + 5*d_x_101
    self.transistor(2, x1, y, w_d, self.n_d, self.l_d, True, False, 101, d_x_101, 2*d_x_101, 0)
    #gates name
    iTregion = pya.TextGenerator.default_generator().text\
